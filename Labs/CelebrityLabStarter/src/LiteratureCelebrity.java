 ...
 * This will help you with Activity 4.
 * Take a look at CartoonCelebrity as well.
 */
...
{
  /**
   * The list of clues for the Literature Celebrity. They can be titles of
   * texts, important characters, settings, etc...s
   */
  private ArrayList<String> clueList;

  /**
   * Builds a LiteratureCelebrity instance with an answer and a series of clues
   * as a String separated by commas.
   * 
   * @param answer
   *          The literature celebrity
   * @param clues
   *          Clues for the literature celebrity
   */
  ...
  {
    String dsc =
      "This is the literature celebrity: " + getAnswer() + "\nThe clues are:\n";
