...
/**
 * The start screen for the CelebrityGame app. You will have to hack this file
 * in Activity 4.
 * 
...
public class StartPanel extends JPanel
{
  ...
  // Activity 4 - Question 10 goes here - JRadioButton for Cartoon Class
  ...
  // Activity 4 - Question 10 goes here - String for Cartoon Class Clue format
  ...
  public StartPanel(CelebrityGame controller)
  {
    ...
    // Activity 4 - Question 11 goes here - New JRadioButton Cartoon Class
    // button

    this.celebrityClue = "Enter the clue for the celebrity";
    this.literatureClue =
      "Enter the clues for the literature celeb separated by commas";
    // Activity 4 - Question 11 goes here - New clue format Cartoon Class string
    // note: the pdf calls this nameOfCelebrity but should be cartoonClue

    this.clueLabel = new JLabel(celebrityClue);

    this.answerField =
      new JTextField("Type celebrity here (4 letters minimum)");
    this.clueField =
      new JTextField("Enter celebrity clue here (10 letters minimum)");
  ...
  private boolean validate(String answerText, String clueText)
  {
    ...
    // Activity 4 - Question 15 goes here
  ...
  private void setupPanel()
  {
    ...
    // Activity 4 - Question 12 - You'll need to add the button here similar
    ...
    // Activity 4 - Question 12 goes here
  ...
  private void setupLayout()
  {
    ...
    // Activity 4 - Question 13 goes here - New JRadioButton Cartoon Class
    ...
    // Now you should see a new radio button for the CartoonCelebrity when you run the app.
  ...
  private void setupListeners()
  {
    ...
    celebrityRadio
      .addActionListener(select -> clueLabel.setText(celebrityClue));
    // Activity 4 - Question 14 goes here
  ...
  private void addToGame()
  {
    ...
    // Activity 4 - Question 16 goes here
